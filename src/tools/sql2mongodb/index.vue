...
usePageMeta('SQL转MongoDB Schema', '在线SQL转MongoDB Schema工具，CREATE TABLE语句生成MongoDB集合设计')
...
<template>
  <div class="max-w-7xl mx-auto px-4 py-4">
    ...
    <div class="flex items-center justify-between mb-2">
      <h1 class="text-xl font-bold">SQL 转 MongoDB Schema</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4" :class="showHistory ? 'lg:grid-cols-3' : ''">
      ...
      <div class="flex flex-col">
        <label class="text-sm font-medium mb-1" :style="{ color: 'var(--text-secondary)' }">MongoDB</label>
        <div class="flex-1 min-h-[400px]">
